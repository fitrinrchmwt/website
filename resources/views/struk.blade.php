    ...
    @section('page')
        ...
        <header class="font-poppins">
            <div class="py-6">
                <div class="pl-4 text-sm font-medium flex items-start gap-x-1">
                    <a href="/pemesanan" class="text-gray-900 hover:text-[#00BCB5] -400 transition duration-400">Pemesanan</a>
                    <span class="opacity-50">
                        /
                    </span>
                    <a href="/toko/struk" class="text-gray-900 hover:text-[#00BCB5] -400 transition duration-400">Pembayaran
                    </a>
                </div>
                <div>
        ...
        <main class="font-poppins py-10 bg-slate-100 max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="sm:w-11/12 lg:w-3/4 mx-auto">
                <!-- Card -->
                <form id="whatsapp-form" action="https://wa.me/62895380190469?text=" method="get" target="_blank"
                    onsubmit="return prepareWhatsAppMessage()">
                    <div class="flex flex-col p-8 sm:p-10 bg-white shadow-md rounded-xl">
                        <!-- Header -->
                        <div class="flex justify-between">
                            <h1 class="mt-2 text-lg md:text-xl font-bold text-[#00BCB5] -400">Wedrink</h1>
                            <div class="text-end">
                    ...
                    <button type="submit"
                        class="py-2 px-3 inline-flex items-end gap-x-3 mt-4 text-sm font-medium rounded-lg border border-transparent bg-[#00BCB5] -400 text-white hover:bg-[#00BCB5] -500 focus:outline-none focus:bg-[#00BCB5] -500">
