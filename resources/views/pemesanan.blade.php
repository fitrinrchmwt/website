        ...
        <main class="bg-black">
            <div id="animation-carousel" class="relative w-full" data-carousel="static">
                ...
                <button type="button"
                    ...
                    data-carousel-prev>
                    <span
                        class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#00BCB5] -400/30
                        group-focus:ring-4 group-focus:ring-[#00BCB5] -400 group-focus:outline-none">
                        <svg class="w-4 h-4 text-[#00BCB5] -400 rtl:rotate-180" aria-hidden="true"
                        ...
                        <div>
                            <div class="relative h-[20em]">
                                ...
                                <div
                                    ...
                                    <a href="{{ route('menu.show', $item->slug) }}"
                                        class="px-4 py-2 font-semibold text-slate-100 ring-1 ring-[#00BCB5] -400 bg-transparent rounded hover:bg-[#00BCB5] -400 duration-300">Lihat
                                        Detail</a>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="flex items-center gap-x-2">
                                    <h1 class="text-xl font-medium text-[#00BCB5] -400">Rp
            ...
            <div class="pt-10 pb-10 text-center">
                ...
                <div class="flex items-center justify-center mt-4">
                    ...
                    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded">
                        <div class="h-5 bg-[#00BCB5] -300 rounded" style="width: 95%"></div>
                    </div>
                ...
                <div class="flex items-center justify-center mt-4">
                    ...
                    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded">
                        <div class="h-5 bg-[#00BCB5] -300 rounded" style="width: 5%"></div>
                    </div>
                ...
                <div class="flex items-center justify-center mt-4">
                    ...
                    <div class="w-2/4 h-5 mx-4 bg-gray-200 rounded">
                        <div class="h-5 bg-[#00BCB5] -300 rounded" style="width: 0%"></div>
                    </div>
