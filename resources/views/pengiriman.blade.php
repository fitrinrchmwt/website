    ...
    @section('page')
        ...
        <header class="font-poppins">
            <div class="py-6">
                <div class="pl-4 text-sm font-medium flex items-start gap-x-1">
                    ...
                    <a href="/pemesanan" class="text-gray-900 hover:text-[#00BCB5] -400 transition duration-400">Pengiriman
                    </a>
                </div>
                <div>
        ...
        <main class="px-4 py-8 font-poppins bg-slate-100 lg:px-20">
            <form action="{{ route('struk') }}" method="POST">
                ...
                <!-- Tombol Submit -->
                <button type="submit"
                    class="text-[#00BCB5] -400 font-bold uppercase rounded-l-lg bg-transparent ring ring-[#00BCB5] -400 hover:bg-[#00BCB5] -400 hover:text-slate-100 transition duration-400 focus:ring-4 focus:outline-none focus:ring-[#00BCB5] -300 text-lg w-full sm:w-auto px-5 py-2.5 text-center lg:py">Lanjut</button>
            </form>
        </main>
    @endsection
</x-layout>
