<footer class="bg-zinc-900">
    <div class="mx-auto max-w-screen-xl space-y-8 px-4 pt-16 pb-7 sm:px-6 lg:space-y-16 lg:px-8">
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-4">
            <div>
                <div class="text-[#00BCB5]  font-poppins flex items-center gap-x-4">
                    <img src="{{ asset('images/' . 'logo.png') }}" alt="" class="h-20" />
                    <!-- <h1 class="font-semibold text-3xl">Wedrink</h1> -->
                </div>
                <p class="mt-4 max-w-xs text-slate-100">Minuman berkualitas tinggi dengan pelayanan profesional,
                    terpercaya
                    untuk acara Anda.</p>
                ...
                <ul class="mt-8 flex gap-6">
                    <li>
                        <a href="https://facebook.com/" rel="noreferrer" target="_blank"
                            class="text-[#00BCB5] transition hover:opacity-75">
                    ...
                    <li>
                        <a href="https://instagram.com" rel="noreferrer" target="_blank"
                            class="text-[#00BCB5] -400 transition hover:opacity-75">
                    ...
                    <ul class="mt-4 space-y-1 text-md font-poppins">
                        <li>
                            <a href="{{ route('beranda') }}"
                                class="block py-2 px-3 transition hover:text-[#00BCB5]  {{ $activePage === 'beranda' ? 'text-bg-[#00BCB5] ' : 'text-slate-100' }}">
                                Beranda
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="{{ route('kontak') }}"
                                class="block py-2 px-3 transition hover:text-[#00BCB5] -400 {{ $activePage === 'kontak' ? 'text-[#00BCB5] -400' : 'text-slate-100' }}">
                                Kontak
                            </a>
                        </li>
                    </ul>
                ...
                <div>
                    ...
                    <ul class="mt-6 space-y-4 text-md font-poppins">
                        <li class="flex items-center gap-x-4">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" class="text-[#00BCB5] -400" />
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z"
                                    class="text-[#00BCB5] -400" />
                            </svg>
                        ...
                        <li class="flex items-center gap-x-4">
                            ...
                            <a href="https://wa.me/62895380190469" target="_blank"
                                class="text-slate-100 transition hover:opacity-75"> 0895380190469</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="col-span-3 space-y-6">
                        ...
                        <div class="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                            <form class="w-full" name="submit-to-google-sheet">
                                ...
                                <div class="border border-[#00BCB5] -100 p-2 sm:flex sm:items-center sm:gap-4">
                                    <input type="tel" id="number" name="number" placeholder="08xx xxxx xxxx"
                                        class="w-full p-3 border-none rounded-md focus:border-transparent focus:ring-[#00BCB5] -400 sm:text-sm"
                                        required />
                                    <button type="submit" id="submit"
                                        class="mt-3 flex items-center justify-center w-full bg-[#00BCB5] -500 px-6 py-3 text-sm font-bold uppercase tracking-wide text-slate-100 transition-none rounded-md hover:bg-[#00BCB5] -600 sm:mt-0 sm:w-auto sm:shrink-0">
                                        Kirim
                                    </button>
                                </div>
    ...
    <div class="flex items-center justify-center w-full">
      ...
      <span class="ml-2 md:hidden">Loading...</span>
                ...
                button.classList.add("bg-[#00BCB5] -400", "cursor-not-allowed");
                ...
                fetch(scriptURL, {
                    ...
                    .then((response) => {
                        ...
                        button.classList.remove("bg-[#00BCB5] -400", "cursor-not-allowed");
                        button.classList.add("bg-[#00BCB5] -500", "hover:bg-[#00BCB5] -600");
